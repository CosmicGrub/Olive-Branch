// OLIVE BRANCH — Uno, the ad-hoc local card game engine. CORRECTED marker:
// this used to read "UNVERIFIED (no Flutter toolchain in tools/verify.sh's
...
// this file IS verified by CI now. The stale marker itself is a real,
// disclosed, separate follow-up across the ~78 other client files still
// carrying it (see CHANGELOG v0.49.60).
//
