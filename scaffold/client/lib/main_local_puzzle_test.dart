...
// in this repo. Network resilience & ad-hoc mode roadmap, Track B Option
// 2, ad-hoc games expansion.
//
...
void main() {
  runApp(const _OliveLocalPuzzleTest());
}

class _OliveLocalPuzzleTest extends StatelessWidget {
  const _OliveLocalPuzzleTest();

  @override
  Widget build(BuildContext context) => MaterialApp(
    title: 'Olive (local puzzle test)',
    theme: ThemeData(colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple), useMaterial3: true),
    home: const GamePuzzleScreen(role: _role, displayName: _displayName),
  );
}
