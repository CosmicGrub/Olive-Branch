...
for spec in \
  ...
  "route contract: parental controls (visibility & pacing)|server/test/guardian_activity_override_route_test.mjs" \
  ...
  "game favorites engine (Recommended row)|packages/games/test/favorites.test.mjs" \
