...
> an adversarial review.** `GET /v1/children/:id/export` (§7.9's own
> already-documented shape) is registered once (`server/routes.mjs`),
...
> entries for the full test/verification list.
