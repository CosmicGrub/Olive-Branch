...
**v0.49.70 is the first pass to give `Posture.foldCover`/`Posture.
...
**Something does, as of v0.49.70.** `TabletopSplit` (new
...
CHANGELOG v0.49.70 and `docs/superpowers/specs/2026-09-12-intuitivism-
...
*End of MASTERFILE v0.49.69. Amend in place. Bump version. Log in CHANGELOG.
