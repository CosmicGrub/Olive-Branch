...
established. **Batch C (two younger-age visual activities) remains
unbuilt**, scoped for a later pass per the spec's own batching plan. See
CHANGELOG v0.49.20.
...
*End of MASTERFILE v0.49.18. Amend in place. Bump version. Log in CHANGELOG.
